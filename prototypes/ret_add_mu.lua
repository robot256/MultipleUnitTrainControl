...
if mods["Realistic_Electric_Trains"] then
	...
	createMuLoco("ret-electric-locomotive","ret-electric-locomotive-mu","item",false)
	createMuLoco("ret-electric-locomotive-mk2","ret-electric-locomotive-mk2-mu","item",false)
